...
const CampaignList: React.FC<CampaignListProps> = ({ campaigns }) => {
  return (
    <div className="w-full px-10 flex flex-col justify-center items-center space-y-2">
      <div className="w-full space-x-2 py-2 flex flex-row justify-between bg-clip-text text-transparent bg-gradient-to-b from-neutral-200 to-neutral-400 font-sans font-bold text-2xl bg-slate-400">
